...
class SixModuleSelectionLayout extends StatelessWidget {
  final int layoutNumber;

  const SixModuleSelectionLayout({
    Key? key,
        ...
        ? SizedBox(
            ...
            child: Stack(
              children: [
                Column(
                  children: [
                    clearButton(layoutNumber, controller, 6),
                    Center(
                      child: SingleChildScrollView(
                        ...
                        child: SizedBox(
                          width: 504.16,
                          height: 200,
                          child: SixModuleLayout(layoutNumber: layoutNumber),
                        ),
                      ),
                    ),
                  ],
            ...
            child: Stack(
              children: [
                ...
                Positioned(
                    ...
                    child: clearButton(layoutNumber, controller, 6))
              ],
            ),
          );
  }
