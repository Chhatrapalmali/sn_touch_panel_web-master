...
class EightModuleVerticalSelectionLayout extends StatelessWidget {
  final int layoutNumber;

  const EightModuleVerticalSelectionLayout(
      {Key? key, required this.layoutNumber})
      : super(key: key);
            ...
            child: Stack(
              children: [
                Column(
                  ...
                  children: [
                    clearButton(layoutNumber, controller, 4),
                    Center(
                      child: SingleChildScrollView(
                        ...
                        child: SizedBox(
                          width: 337.5,
                          height: 200,
                          child: FourModuleLayout(layoutNumber: layoutNumber),
                        ),
                      ),
                    ),
                  ],
            ...
            child: Stack(
              children: [
                ...
                Positioned(
                    ...
                    child: clearButton(layoutNumber, controller, 4))
              ],
            ),
          );
  }
