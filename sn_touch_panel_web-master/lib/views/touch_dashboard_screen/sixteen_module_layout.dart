...
import 'components/eight_module_selection_layout.dart';

class SixteenModuleLayout extends StatelessWidget {
  const SixteenModuleLayout({Key? key}) : super(key: key);
                    ...
                    child: InkWell(
                      onTap: () {
                        Get.defaultDialog(
                          ...
                          content: const EightModuleSelectionLayout(
                            layoutNumber: 1,
                          ),
                        );
                      },
