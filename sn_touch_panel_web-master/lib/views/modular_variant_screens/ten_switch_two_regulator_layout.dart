...
class TenSwitchTwoRegulatorLayout extends StatelessWidget {
  ...
  final int icon9Index;
  final int icon10Index;
  final int layoutNumber;

  const TenSwitchTwoRegulatorLayout({
    Key? key,
    ...
    required this.icon9Index,
    required this.icon10Index,
